"""
Django settings for unimax_erp project.
...
SECRET_KEY = '#(i!wmhb%r&g%c=#-7&)it#ea9qlb6mb(u9t)!(kph7pe%ww18'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'unimax_erp.context_processors.service_urls'
            ],
        },
    },
]

WSGI_APPLICATION = 'unimax_erp.wsgi.application'
